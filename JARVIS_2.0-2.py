...
with open(r"G:\ml\facerecognition\admin.csv",'r') as new_file:
...
f=open(r"G:\ml\facerecognition\logs\test.txt", "a+")
        ...
        if True:
            ...
            for face_encoding in face_encodings:
                ...
                if name not in v and name != "Unknown": 
                    ...
                    img_name = "G:/ml/facerecognition/jarvis/"+xa+".png"
                    cv2.imwrite(img_name, frame)
                    myData = [xa,img_name]
                    with open(r"G:\ml\facerecognition\admin.csv",'a') as csv_file:
